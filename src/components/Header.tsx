      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <Button
              asChild
              className="gradient-accent text-primary-foreground rounded-lg px-6 shadow-soft hover:shadow-hover transition-all duration-300"
            >
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-background/95 backdrop-blur-md border-b border-border animate-fade-in">
            <nav className="flex flex-col p-6 gap-4">
              ...
              <Button
                asChild
                className="gradient-accent text-primary-foreground rounded-lg mt-4"
              >
