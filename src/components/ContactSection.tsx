...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: "", email: "", business: "", requirements: "" });
  };
          ...
          <form onSubmit={handleSubmit} className="neumorphic p-8 sm:p-10 rounded-2xl animate-fade-up delay-200">
            <div className="grid sm:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="neumorphic-inset border-0 rounded-xl h-12 px-4 focus:ring-2 focus:ring-primary/20"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2 mb-6">
              ...
              <Textarea
                ...
                onChange={handleChange}
                placeholder="Describe your ideal customer profile, target industries, company sizes, job titles, locations, or any specific criteria..."
                rows={5}
                required
                className="neumorphic-inset border-0 rounded-xl px-4 py-3 resize-none focus:ring-2 focus:ring-primary/20"
              />
            </div>
            ...
            <div className="space-y-2 mb-8">
              ...
              <div className="neumorphic-inset rounded-xl p-4 flex items-center justify-center border-2 border-dashed border-border hover:border-primary/50 transition-colors cursor-pointer">
                <div className="text-center">
                  <Upload className="w-8 h-8 text-muted-foreground mx-auto mb-2" />
                  <p className="text-sm text-muted-foreground">
                    Drag & drop or click to upload sample data or requirements doc
                  </p>
                </div>
